...
export class AuthService {
    ...
    auth0 = new Auth0({ clientID: 'Yd33YAeAmZsF5p6pThvzkiTVnlhRYtnb', domain: 'demoapp2016.auth0.com' });
    lock = new Auth0Lock('Yd33YAeAmZsF5p6pThvzkiTVnlhRYtnb', 'demoapp2016.auth0.com', {
        auth: {
            redirect: false,
            params: {
